        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.person_rounded, color: color, size: 36),
            ),
            const SizedBox(height: 20),
            const Text('Profile & Contacts',
              style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: color, fontFamily: 'Poppins')),
