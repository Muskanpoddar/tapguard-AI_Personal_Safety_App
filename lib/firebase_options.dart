// File generated by FlutterFire CLI, then refactored to read every
// secret from the .env file at runtime (loaded by main.dart via
// flutter_dotenv). See docs/SECURITY.md for the rotation runbook.
//
...
class DefaultFirebaseOptions {
  ...
  static String _env(String key) =>
      dotenv.maybeGet(key) ?? (throw StateError(
            'firebase_options: missing "$key" in .env — see docs/SECURITY.md',
          ));
